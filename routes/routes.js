...
async function unLoadHeader(){
    header['data'] = await fs.readFile(path.join(__dirname,"../frontend/header.html"),"utf8");
    header['content'] = await fs.readFile(path.join(__dirname,"../content/header.json"),"utf8");
    footer['data'] = await fs.readFile(path.join(__dirname,"../frontend/footer.html"),"utf8");
